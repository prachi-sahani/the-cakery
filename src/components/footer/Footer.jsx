    ...
    <footer className="footer">
      <div className="footer-upper">
        <ul className="footer-quick-links list-group txt-left">
          ...
          <Link to="/" className="link">
            <li className="list-item">Cancellation & Refund Policy</li>
          </Link>
          <Link to="/" className="link">
        ...
        <ul className="footer-contact-links list-group txt-left">
          ...
          <a className="link" href="mailto:support@cakery.com">
            <li className="list-item">
      ...
      <div className="footer-lower mt-4 txt-sm">
        &copy; 2022 <strong>The Cakery</strong>. All rights reserved. Designed
